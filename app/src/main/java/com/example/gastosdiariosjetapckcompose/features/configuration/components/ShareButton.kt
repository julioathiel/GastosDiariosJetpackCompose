package com.example.gastosdiariosjetapckcompose.features.configuration.components
...
@Composable
fun ShareSheet(appDownloadLink: String, onDissmiss: () -> Unit) {
    ...
    LaunchedEffect(Unit) {
        ...
        onDissmiss() // Llama a la función onDissmiss después de lanzar la actividad de compartir
    }
}